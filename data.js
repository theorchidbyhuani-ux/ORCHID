...
const globalServicesData = {
    eyelash: [
        { name: "Full Glam Classic Set", price: 100, description: "Full glam classic lash extensions", category: "classic", duration: 120 },
        { name: "Natural Hybrid Set", price: 100, description: "Natural hybrid lash extensions", category: "hybrid", duration: 150 },
        { name: "Elegant Hybrid Set", price: 120, description: "Elegant hybrid lash extensions", category: "hybrid", duration: 150 },
        { name: "Glam Hybrid Set", price: 130, description: "Glam hybrid lash extensions", category: "hybrid", duration: 150 },
        { name: "Volume Full Set", price: 150, description: "Volume lash extensions", category: "volume", duration: 180 },
        { name: "Mega Volume Full Set", price: 180, description: "Mega volume lash extensions", category: "volume", duration: 180 },
        { name: "Full Glam Classic Refill", price: 80, description: "2-week refill for Full Glam Classic", category: "refill", duration: 75 },
        { name: "Natural Hybrid Refill", price: 80, description: "2-week refill for Natural Hybrid", category: "refill", duration: 90 },
        { name: "Elegant Hybrid Refill", price: 90, description: "2-week refill for Elegant Hybrid", category: "refill", duration: 90 },
        { name: "Glam Hybrid Refill", price: 100, description: "2-week refill for Glam Hybrid", category: "refill", duration: 90 },
        { name: "Volume Refill", price: 120, description: "2-week refill for Volume", category: "refill", duration: 120 },
        { name: "Mega Volume Refill", price: 150, description: "2-week refill for Mega Volume", category: "refill", duration: 120 },
